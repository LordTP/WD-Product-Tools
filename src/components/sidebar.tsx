  ...
  return (
    ...
    >
      <div className="pt-5 pb-3 px-5">
        <p className="font-brand text-[19px] leading-none tracking-wide text-slate-900">WANDERDOLL</p>
        <p className="text-[9px] tracking-[0.3em] text-slate-400 mt-1.5">PRODUCT TOOLS</p>
      </div>
      ...
      <div className="p-2 border-t border-slate-100">
        <button
          onClick={logout}
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-sm text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors"
        >
